<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="number" name="lessons" class="form-control" value="{{ old('lessons', $course->lessons ?? '') }}"
            required>
    </div>
    <div class="col-md-6">
        <label class="form-label">Students</label>
        <input type="number" name="students" class="form-control"
            value="{{ old('students', $course->students ?? '') }}" required>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="role" class="form-control" value="{{ old('role', $course->role ?? '') }}"
            required>
    </div>
    <div class="col-md-6">
        <label class="form-label">Rating</label>
        <input type="number" name="rating" class="form-control" min="1" max="5"
            value="{{ old('rating', $course->rating ?? 1) }}" required>
    </div>
    <div class="col-md-6">
        ...
        <div class="mt-2">
            <img id="image-preview"
                ...
                class="img-thumbnail d-block" style="width:150px;height:auto;" alt="Image Preview">
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="mt-2">
            <img id="avatar-preview"
                ...
                class="img-thumbnail d-block" style="width:80px;height:80px;" alt="Avatar Preview">
        </div>
    </div>
</div>
<div class="mt-4">
    <button type="submit" class="btn btn-{{ isset($course) ? 'warning' : 'primary' }}">
